...
import { AdminStats, AdminUserRow } from '@/types/admin';
      ...
      <div className="w-full max-w-4xl">
        ...
        {stats && (
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-8">
            <StatCard label="ユーザー数" value={stats.totalUsers} />
            <StatCard label="閲覧のみ" value={stats.readOnlyUsers} />
            <StatCard label="句動詞数" value={stats.totalPhrasalVerbs} />
